...
describe('Tests with Location State', function () {
  it('Launches the skill', function (done) {
    // Launch the skill via launch request
...
describe('Tests with Date State', function () {
  it('Launches the skill', function (done) {
    // Launch the skill via launch request
...
describe('Tests with Time State', function () {
  it('Launches the skill', function (done) {
    // Launch the skill via launch request
...
describe('Tests with numGolfers State', function () {
  it('Launches the skill', function (done) {
    // Launch the skill via launch request
...
describe('Tests with price State', function () {
  it('Launches the skill', function (done) {
    // Launch the skill via launch request
    alexa._alexa._context._session.updateAttributes({'STATE': 'price'})
    alexa.launched(function (error, payload) {
      if (error) {
        console.log(error)
        done()
